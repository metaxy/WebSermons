...
/**
 * Plugin 'Last Sermons' for the 'websermons' extension.
 *
 * @author	 <>
 * @package	TYPO3
 * @subpackage	tx_websermons
 */
class tx_websermons_plast extends tslib_pibase {
	public $prefixId      = 'tx_websermons_plast';		// Same as class name
	public $scriptRelPath = 'plast/class.tx_websermons_plast.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/websermons/plast/class.tx_websermons_plast.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/websermons/plast/class.tx_websermons_plast.php']);
}
